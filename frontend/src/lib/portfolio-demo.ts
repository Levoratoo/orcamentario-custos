...
const createInitialState = (): DemoState => {
  ...
  const bscIndicators: DemoBscIndicator[] = [
    ...
    },
    {
      ...
      perspective: 'FINANCEIRO',
      objective: 'Expandir margem operacional',
      responsible: 'Controller Portfolio',
      dataOwner: 'Controladoria',
      process: 'Financeiro',
      keywords: 'margem,ebitda,rentabilidade',
      level: 2,
      direction: 'HIGHER_IS_BETTER',
      yearTargets: [{ year: 2025, targetValue: 35, rawValue: null }, { year: 2026, targetValue: 38, rawValue: null }],
      monthlyByYear: { 2025: buildMonthlyBscSeries(2.7, 2.45, 0.04, 0.035), 2026: buildMonthlyBscSeries(2.9, 2.6, 0.045, 0.04) },
      actionPlans: [{ id: 'plan-fin-2', fact: 'Margem pressionada no mix de produtos', cause: 'Desconto comercial acima do previsto', action: 'Ajustar politica de descontos e mix por segmento', owner: 'Controller Portfolio', dueDate: '2026-07-10' }],
    },
    {
      id: 'bsc-6',
      code: 'FIN-03',
      name: 'Geracao de Caixa Operacional',
      perspective: 'FINANCEIRO',
      objective: 'Fortalecer caixa operacional',
      responsible: 'Ana Costa',
      dataOwner: 'Tesouraria',
      process: 'Financeiro',
      keywords: 'caixa,operacional,liquidez',
      level: 1,
      direction: 'HIGHER_IS_BETTER',
      yearTargets: [{ year: 2025, targetValue: 780, rawValue: null }, { year: 2026, targetValue: 860, rawValue: null }],
      monthlyByYear: { 2025: buildMonthlyBscSeries(58, 54, 1.2, 1.05), 2026: buildMonthlyBscSeries(64, 60, 1.25, 1.18) },
      actionPlans: [],
    },
    {
      id: 'bsc-7',
      code: 'CLI-02',
      name: 'Retencao de Clientes Chave',
      perspective: 'CLIENTE',
      objective: 'Elevar satisfacao de clientes',
      responsible: 'Joao Lima',
      dataOwner: 'CX Squad',
      process: 'Atendimento',
      keywords: 'retencao,carteira,cliente',
      level: 2,
      direction: 'HIGHER_IS_BETTER',
      yearTargets: [{ year: 2025, targetValue: 88, rawValue: null }, { year: 2026, targetValue: 91, rawValue: null }],
      monthlyByYear: { 2025: buildMonthlyBscSeries(86, 84.5, 0.18, 0.16), 2026: buildMonthlyBscSeries(88, 86.8, 0.2, 0.18) },
      actionPlans: [],
    },
    {
      id: 'bsc-8',
      code: 'CLI-03',
      name: 'Tempo Medio de Resposta',
      perspective: 'CLIENTE',
      objective: 'Acelerar resolucao de chamados',
      responsible: 'Maria Torres',
      dataOwner: 'Suporte',
      process: 'Atendimento',
      keywords: 'sla,resposta,chamado',
      level: 1,
      direction: 'LOWER_IS_BETTER',
      yearTargets: [{ year: 2025, targetValue: 14, rawValue: null }, { year: 2026, targetValue: 12, rawValue: null }],
      monthlyByYear: { 2025: buildMonthlyBscSeries(15.5, 16.8, -0.22, -0.2), 2026: buildMonthlyBscSeries(14, 15.3, -0.2, -0.18) },
      actionPlans: [{ id: 'plan-cli-3', fact: 'Fila de suporte acima do esperado', cause: 'Pico de chamados apos rollout', action: 'Redistribuir celulas de atendimento por canal', owner: 'Maria Torres', dueDate: '2026-06-01' }],
    },
    {
      id: 'bsc-9',
      code: 'PROC-01',
      name: 'OEE Linha Principal',
      perspective: 'PROCESSOS',
      objective: 'Aumentar produtividade industrial',
      responsible: 'Carlos Prado',
      dataOwner: 'Engenharia',
      process: 'Producao',
      keywords: 'oee,eficiencia,producao',
      level: 1,
      direction: 'HIGHER_IS_BETTER',
      yearTargets: [{ year: 2025, targetValue: 79, rawValue: null }, { year: 2026, targetValue: 83, rawValue: null }],
      monthlyByYear: { 2025: buildMonthlyBscSeries(77, 74.5, 0.35, 0.32), 2026: buildMonthlyBscSeries(79, 76.5, 0.36, 0.34) },
      actionPlans: [],
    },
    {
      id: 'bsc-10',
      ...
      keywords: 'leadtime,fluxo,agilidade',
      level: 2,
      direction: 'LOWER_IS_BETTER',
      yearTargets: [{ year: 2025, targetValue: 12.5, rawValue: null }, { year: 2026, targetValue: 11.3, rawValue: null }],
      monthlyByYear: { 2025: buildMonthlyBscSeries(13.8, 14.2, -0.12, -0.1), 2026: buildMonthlyBscSeries(13, 13.4, -0.11, -0.1) },
      actionPlans: [],
    },
    {
      id: 'bsc-11',
      code: 'APR-02',
      name: 'Turnover de Talentos Criticos',
      perspective: 'APRENDIZADO_CRESCIMENTO',
      objective: 'Desenvolver e reter talentos',
      responsible: 'Ana Costa',
      dataOwner: 'RH',
      process: 'Gente e Gestao',
      keywords: 'turnover,pessoas,retencao',
      level: 2,
      direction: 'LOWER_IS_BETTER',
      yearTargets: [{ year: 2025, targetValue: 9, rawValue: null }, { year: 2026, targetValue: 7.5, rawValue: null }],
      monthlyByYear: { 2025: buildMonthlyBscSeries(9.8, 10.4, -0.06, -0.05), 2026: buildMonthlyBscSeries(9.1, 9.5, -0.055, -0.05) },
      actionPlans: [],
    },
    {
      id: 'bsc-12',
      code: 'APR-03',
      name: 'Cobertura de Competencias Criticas',
      perspective: 'APRENDIZADO_CRESCIMENTO',
      objective: 'Capacitar equipe critica',
      responsible: 'Paula Ribeiro',
      dataOwner: 'Universidade Corporativa',
      process: 'Treinamento',
      keywords: 'competencia,capacitacao,academia',
      level: 1,
      direction: 'HIGHER_IS_BETTER',
      yearTargets: [{ year: 2025, targetValue: 72, rawValue: null }, { year: 2026, targetValue: 78, rawValue: null }],
      monthlyByYear: { 2025: buildMonthlyBscSeries(68, 64, 0.38, 0.34), 2026: buildMonthlyBscSeries(71, 67, 0.42, 0.38) },
      actionPlans: [{ id: 'plan-apr-3', fact: 'Gap de habilidades em processos digitais', cause: 'Expansao acelerada de squads', action: 'Trilha intensiva de formacao tecnica', owner: 'Paula Ribeiro', dueDate: '2026-08-20' }],
    },
  ];
